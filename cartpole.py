...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(args.epochs):
            ...
            # After iterationg through all episodes in an epoch, train models
            if args.baseline:
            ...
            loss_, _ = sess.run([network.loss, network.train], feed_dict=feed)

            # Calculate and store the average total reward for the epoch
